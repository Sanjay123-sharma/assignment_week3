    ...
    <div className="first">
      ...
      <div>
        <div style={{ margin: "1rem" }} className="bottom">
          {List.length === 0 ? (
            <h4 style={{ fontFamily: "initial", color: "rgb(113, 113, 248)" }}>
              No tasks available.
            </h4>
          ) : (
            ""
          ...
          {List.map((task, i) => (
            <div key={i} style={{ gap: "10px" }} className="list">
              <div className="item">
                ...
                <div style={{ color: task.isCompleted ? "green" : "blue" }}>
                  {task.description}
                </div>
                <div>
                  <button onClick={() => handleDelete(task.id)} id="btn3">
                    DELETE
                  </button>
                </div>
                <div>
                  <button onClick={() => handleCompleted(task.id)} id="btn4">
                    COMPLETED
                  </button>
                </div>
              </div>
